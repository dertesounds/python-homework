...
difference_in_price = original_price - current_price

print(f"Difference in price is {difference_in_price")

# Calculate percent_increase

percent_increase = (difference_in_price / current_price) * 100
